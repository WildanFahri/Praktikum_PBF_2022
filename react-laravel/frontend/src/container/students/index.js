...
export default class Student extends Component {
    ...
    onChangeShowStudentHanler = (e) => {
        let { showStudentData } = this.state;
        showStudentData[e.target.name] = e.target.value;
        this.setState({ showStudentData });
    };
    ...
    showStudent = (id, first_name, last_name, email, phone) => {
        this.setState({
            showStudentData: {
                id, first_name, last_name, email,
                phone
    ...
    // };
    render() {
        const { newStudentData, editStudentData, noDataFound, showStudentData,
            students } =
            this.state;
        let studentsDetails = [];
        if (students.length) {
        ...
        return (
            <div className="App container mt-4">
                <h4 className="font-weight-bold">Students
                    Registration</h4>
                ...
                />
                <ShowStudent
                    toggleShowStudentModal={this.toggleShowStudentModal}
                    showStudentModal={this.state.showStudentModal}
                    onChangeShowStudentHanler={this.onChangeShowStudentHanler}
